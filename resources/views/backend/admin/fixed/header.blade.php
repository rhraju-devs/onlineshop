<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
    ...
    <div class="m-header">
        ...
        <a href="#!" class="b-brand">
            ...
            <img src="{{url('backend/assets/images/logo.png')}}" alt="" class="logo">
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{url('backend/assets/images/user/avatar-1.jpg')}}"
                                        alt="Generic placeholder image">
                                    <div class="media-body">
                                        <p><strong>Soeng Souy</strong><span class="n-time text-muted"><i
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="{{url('backend/assets/images/user/avatar-1.jpg')}}" class="img-radius"
