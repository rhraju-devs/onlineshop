                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-inline-block align-middle">
                                            <img src="{{url('backend/assets/images/user/avatar-3.jpg')}}" alt="user image"
                                                class="img-radius wid-40 align-top m-r-15">
                                            <div class="d-inline-block">
                                                <h6>William Jem</h6>
                ...
                <div class="card-body">
                    ...
                    <div class="row m-b-20 received-chat">
                        ...
                        <div class="col">
                            <div class="msg">
                                <p class="m-b-0">Nice to meet you!</p>
                                <img src="{{url('backend/assets/images/widget/dashborad-1.jpg')}}" alt="">
                                <img src="{{url('backend/assets/images/widget/dashborad-3.jpg')}}" alt="">
                            </div>
                            <p class="text-muted m-b-0"><i class="fa fa-clock-o m-r-10"></i>10:20am</p>
                        </div>
                    </div>
