                            ...
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control text-uppercase" id="firstName" value="{{auth()->user()->firstname}}" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label for="lastName">Last Name :</label>
                                        <input type="text" class="form-control text-uppercase" id="lastName" value="{{auth()->user()->lastname}}" readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="displayName">Full Name :</label>
                                        <input type="text" class="form-control text-capitalize" id="displayName" value="{{auth()->user()->firstname}} {{auth()->user()->lastname}}" readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="emailAddress">Email Address :</label>
                                        <input type="email" class="form-control" id="emailAddress" value="{{auth()->user()->email}}" readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
