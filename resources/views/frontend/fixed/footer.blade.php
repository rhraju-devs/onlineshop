                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="payment_method">
                            <img src="{{url('frontend/img/payment-method/paypal.png')}}" alt="">
                            <img src="{{url('frontend/img/payment-method/maestro.png')}}" alt="">
                            <img src="{{url('frontend/img/payment-method/western-union.png')}}" alt="">
                            <img src="{{url('frontend/img/payment-method/discover.png')}}" alt="">
                            <img src="{{url('frontend/img/payment-method/american-express.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
