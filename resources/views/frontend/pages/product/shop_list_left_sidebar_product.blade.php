                            ...
                            <div class="single-product-area mb-30">
                                ...
                                <div class="product_description">
                                    ...
                                    <div class="product_quick_view">
                                        <a href="#" data-toggle="modal" data-target="#product{{$key}}"><i
...
<!-- Shop List Area -->
                        ...
                        <!-- Quick View Modal Area -->
                        <div class="modal fade" id="quickview" tabindex="-1" data-keyboard="false" data-backdrop="static"  role="dialog" aria-labelledby="quickview" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                <div class="modal-content">
