                    ...
                    <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item {{$key == 0 ? 'active' : ''}}">
                                ...
                                <a class="gallery_img" href="{{asset('/uploads/product_images/'. $image->image)}}"
                                    title="First Slide">
                                    <img class="d-block w-100"
                                        src="{{asset('/uploads/product_images/'. $image->image)}}" alt="First slide">
                                </a>
                                <!-- Product Badge -->
                                <div class="product_badge">
                                    <span class="badge-new">New</span>
            ...
            <div class="col-12 col-lg-6">
                <div class="single_product_desc">
                    ...
                    <div class="others_info_area mb-3 d-flex flex-wrap">
                        <a class="add_to_wishlist" href="{{route('product.wishlist', $product->id)}}"><i
                    ...
                    <div class="single-product-area">
                        <div class="product_image">
                            ...
                            <img class="normal_img"
                                src="{{url('/uploads/product_images/',$product->images->first()->image)}}" alt="">
                            <img class="hover_img"
                                src="{{url('/uploads/product_images/',$product->images->last()->image)}}" alt="">
                            <!-- Product Image -->
